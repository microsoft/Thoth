...
VARS_TO_REMOVE="AZURE_CLIENT_ID AZURE_ENV_NAME AZURE_TENANT_ID AZURE_LOCATION AZURE_RESOURCE_GROUP AZURE_SUBSCRIPTION_ID AZURE_DOCUMENT_INTELLIGENCE_LOCATION"
